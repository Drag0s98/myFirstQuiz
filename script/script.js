//Declaramos las preguntas correctas.
...
document.querySelector('form[name="formulario"]').addEventListener('submit', (event) => {
    ...
    //Seleccionamos las opciones de cada pregunta.
    ...
    }else if (respuestaDos == "pacifico"){
        labelsTres[0].style.backgroundColor = "red"
    }else if(respuestaDos == "indico"){
        labelsTres[1].style.backgroundColor = "red"
    }else if(respuestaDos == "mediterraneo"){
    ...
    }else if (respuestaDos == "estambul"){
        labelsCuatro[0].style.backgroundColor = "red"
    }else if(respuestaDos == "esmirna"){
        labelsCuatro[2].style.backgroundColor = "red"
    }else if(respuestaDos == "konya"){
        labelsCuatro[3].style.backgroundColor = "red"
    }

    //Pregunta cinco 
    if(respuestaCinco == preguntasCorrectas.segunda){
